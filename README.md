...
- [Futurecoder is an interactive Python course running on Pyodide](https://github.com/alexmojaki/futurecoder), with an [IDE](https://futurecoder.io/course/#ide), REPL, debuggers, and `micropip` support.
